        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <tr>
                        ...
                        <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm">
                            <div class="flex item-center justify-center">
                                ...
                                <div class="w-4 mr-2 transform hover:text-red-900 hover:scale-110">
                                    <a href="{{url('/ticket/'.$model->id.'/edit/')}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                @if($model->status == 0)
                                <div class="w-4 mr-2 transform hover:text-red-900 hover:scale-110">
                                    <a href="{{url('/ticket/'.$model->id.'/edit/?option=1')}}">
                ...
                <div class="px-5 py-3 grid justify-items-center">
                    <a href="{{ url('/importxls') }}" class="inline-flex space-x-4 transform hover:text-red-900 hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd" />
                        </svg> <p class=""> {{__("Import xls")}}</p>
                    </a>
                </div>
